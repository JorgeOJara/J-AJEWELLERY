!function (a) {
    var e = [], t = {options: {prependExistingHelpBlock: false, sniffHtml: true, preventSubmit: true, submitError: false, submitSuccess: false, semanticallyStrict: false, autoAdd: {helpBlocks: true}, filter: function () {
      return true;
      ...
      return a(l).bind("submit", function (e) {
        ...
        }), n.trigger("validationLostFocus.validation"), i ? (r.options.preventSubmit && e.preventDefault(), t.addClass("error"), a.isFunction(r.options.submitError) && r.options.submitError(t, e, n.jqBootstrapValidation("collectErrors", true))) : (t.removeClass("error"), a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(t, e));
      }), this.each(function () {
        ...
        a.each(d, function (e, n) {
          var o = t.data("validation" + n + "Message"), l = void 0 !== o, s = false;
          if (o = o || "'" + n + "' validation failed <!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message -->", a.each(r.validatorTypes, function (e, r) {
            void 0 === h[e] && (h[e] = []), s || void 0 === t.data("validation" + n + i(r.name)) || (h[e].push(a.extend(true, {name: i(r.name), message: o}, r.init(t, n))), s = true);
          }), !s && r.builtInValidators[n.toLowerCase()]) {
            var d = a.extend(true, {}, r.builtInValidators[n.toLowerCase()]);
            l && (d.message = o);
            var c = d.type.toLowerCase();
            "shortcut" === c ? s = true : a.each(r.validatorTypes, function (e, o) {
              void 0 === h[e] && (h[e] = []), s || c !== e.toLowerCase() || (t.data("validation" + n + i(o.name), d[o.name.toLowerCase()]), h[c].push(a.extend(d, o.init(t, n))), s = true);
            });
          }
          ...
          return t.triggerHandler("change.validation", {submitting: true});
      ...
      return this.each(function (e, i) {
        var n = a(i), o = n.attr("name"), r = n.triggerHandler("validation.validation", {includeEmpty: true});
      ...
      return {validatorName: e, callback: a.data("validation" + e + "Callback"), lastValue: a.val(), lastValid: true, lastFinished: true};
    }, validate: function (a, e, t) {
      if (t.lastValue === e && t.lastFinished) return !t.lastValid;
      if (true === t.lastFinished) {
        t.lastValue = e, t.lastValid = true, t.lastFinished = false;
        var i = t, n = a;
        !function (a, e) {
          ...
          i.lastValue === a.value && (i.lastValid = a.valid, a.message && (i.message = a.message), i.lastFinished = true, n.data("validation" + i.validatorName + "Message", i.message), setTimeout(function () {
      ...
      return {validatorName: e, url: a.data("validation" + e + "Ajax"), lastValue: a.val(), lastValid: true, lastFinished: true};
    }, validate: function (e, t, i) {
      return "" + i.lastValue == "" + t && true === i.lastFinished ? false === i.lastValid : (true === i.lastFinished && (i.lastValue = t, i.lastValid = true, i.lastFinished = false, a.ajax({url: i.url, data: "value=" + t + "&field=" + e.attr("name"), dataType: "json", success: function (a) {
        "" + i.lastValue == "" + a.value && (i.lastValid = !!a.valid, a.message && (i.message = a.message), i.lastFinished = true, e.data("validation" + i.validatorName + "Message", i.message), setTimeout(function () {
          e.trigger("change.validation");
        }, 1));
      }, failure: function () {
        i.lastValid = true, i.message = "ajax call failed", i.lastFinished = true, e.data("validation" + i.validatorName + "Message", i.message), setTimeout(function () {
          e.trigger("change.validation");
        }, 1);
      }})), false);
    ...
    }, blockSubmit: true}, match: {name: "match", init: function (a, e) {
    ...
    }, blockSubmit: true}, max: {name: "max", init: function (a, e) {
    ...
    }, blockSubmit: true}, minchecked: {name: "minchecked", init: function (a, e) {
      var t = a.parents("form").first().find('[name="' + a.attr("name") + '"]');
      return t.bind("click.validation", function () {
        a.trigger("change.validation", {includeEmpty: true});
